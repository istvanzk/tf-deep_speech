#!/usr/bin/env python
"""
Orginal script from https://github.com/istvanzk/DeepSpeech/tree/master/bin
TODOs: 
- modify to export as TAB delimited CSV file
- use pandas.DataFrame instead of the csv module
- check/integrate other options from download.py
